...
struct GenerateLambdaAPI: ParsableCommand {
    ...
    mutating func run() throws {
        ...
        try fileManager.applyStencils(targetPath: options.targetPath, config: config)
        ...
        try serverlessConfig.writeSLS(params: params, targetPath: options.targetPath, ymlFileName: "serverless.yml")
        ...
        try serverlessConfig_x86_64.writeSLS(params: params, targetPath: options.targetPath, ymlFileName: "serverless-x86_64.yml")
        print("")
